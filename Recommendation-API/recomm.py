...
def Similarity(bookId1, bookId2):
    ...
    ratingA = a['Book-Rating_y']
    ratingB = b['Book-Rating_y']
    
    ratingDistance = int(math.pow((int(math.pow (ratingA, 2)) - int(math.pow (ratingB, 2))),2))
    ...
    return math.sqrt(yearDistance+authorDistance+ratingDistance)
